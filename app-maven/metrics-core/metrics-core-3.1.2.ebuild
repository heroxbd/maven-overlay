...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/metrics-core-3.1.2.pom --download-uri http://central.maven.org/maven2/io/dropwizard/metrics/metrics-core/3.1.2/metrics-core-3.1.2-sources.jar --slot 0 --keywords "~amd64" --ebuild metrics-core-3.1.2.ebuild
...
# Common dependencies
# POM: ../poms/metrics-core-3.1.2.pom
