...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/metrics-core-2.2.0.pom --download-uri http://central.maven.org/maven2/com/yammer/metrics/metrics-core/2.2.0/metrics-core-2.2.0-sources.jar --slot 0 --keywords "~amd64" --ebuild metrics-core-2.2.0.ebuild
...
# Common dependencies
# POM: ../poms/metrics-core-2.2.0.pom
