...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/javax.servlet-3.0.0.v201112011016.pom --download-uri http://central.maven.org/maven2/org/eclipse/jetty/orbit/javax.servlet/3.0.0.v201112011016/javax.servlet-3.0.0.v201112011016-sources.jar --slot 0 --keywords "~amd64" --ebuild javax-servlet-3.0.0.ebuild
