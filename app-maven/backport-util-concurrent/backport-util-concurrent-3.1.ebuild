...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/backport-util-concurrent-3.1.pom --download-uri http://central.maven.org/maven2/backport-util-concurrent/backport-util-concurrent/3.1/backport-util-concurrent-3.1-sources.jar --slot 0 --keywords "~amd64" --ebuild backport-util-concurrent-3.1.ebuild
