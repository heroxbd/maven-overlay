...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/selenium-java-2.35.0.pom --download-uri http://central.maven.org/maven2/org/seleniumhq/selenium/selenium-java/2.35.0/selenium-java-2.35.0-sources.jar --slot 0 --keywords "~amd64" --ebuild selenium-java-2.35.0.ebuild
...
# Common dependencies
# POM: ../poms/selenium-java-2.35.0.pom
