...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/hadoop-yarn-common-2.2.0.pom --download-uri http://central.maven.org/maven2/org/apache/hadoop/hadoop-yarn-common/2.2.0/hadoop-yarn-common-2.2.0-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-yarn-common-2.2.0.ebuild
...
# Common dependencies
# POM: ../poms/hadoop-yarn-common-2.2.0.pom
...
JAVA_GENTOO_CLASSPATH="guice-4,guice-4,protobuf-java,jersey-json,jersey-server,jersey-guice,jersey-test-framework-grizzly2,commons-io-1,netty,log4j,hadoop-annotations,hadoop-yarn-api,slf4j-api,slf4j-api"
