...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/hadoop-mapreduce-client-common-2.2.0.pom --download-uri http://central.maven.org/maven2/org/apache/hadoop/hadoop-mapreduce-client-common/2.2.0/hadoop-mapreduce-client-common-2.2.0-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-mapreduce-client-common-2.2.0.ebuild
...
HOMEPAGE=""
SRC_URI="http://central.maven.org/maven2/org/apache/hadoop/hadoop-mapreduce-client-common/2.2.0/hadoop-mapreduce-client-common-2.2.0-sources.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
IUSE="doc source"
MAVEN_ID="org.apache.hadoop:hadoop-mapreduce-client-common:2.2.0"

# Common dependencies
# POM: ../poms/hadoop-mapreduce-client-common-2.2.0.pom
...
CDEPEND="
	...
	>=app-maven/hadoop-yarn-client-2.2.0:0
