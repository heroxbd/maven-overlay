...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/jboss-interceptors-api_1.1_spec-1.0.0.Beta1.pom --download-uri http://central.maven.org/maven2/org/jboss/spec/javax/interceptor/jboss-interceptors-api_1.1_spec/1.0.0.Beta1/jboss-interceptors-api_1.1_spec-1.0.0.Beta1-sources.jar --slot 1.1_spec --keywords "~amd64" --ebuild jboss-interceptors-api-1.0.0.ebuild
