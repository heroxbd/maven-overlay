...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/jboss-ejb-api_3.1_spec-1.0.0.CR2.pom --download-uri http://central.maven.org/maven2/org/jboss/spec/javax/ejb/jboss-ejb-api_3.1_spec/1.0.0.CR2/jboss-ejb-api_3.1_spec-1.0.0.CR2-sources.jar --slot 3.1_spec --keywords "~amd64" --ebuild jboss-ejb-api-1.0.0.ebuild
...
# Common dependencies
# POM: ../poms/jboss-ejb-api_3.1_spec-1.0.0.CR2.pom
