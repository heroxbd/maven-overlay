...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/webbit-0.4.14.pom --download-uri http://central.maven.org/maven2/org/webbitserver/webbit/0.4.14/webbit-0.4.14-sources.jar --slot 0 --keywords "~amd64" --ebuild webbit-0.4.14.ebuild
