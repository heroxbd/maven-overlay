...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/jetty-6.1.26.pom --download-uri http://central.maven.org/maven2/org/mortbay/jetty/jetty/6.1.26/jetty-6.1.26-sources.jar --slot 0 --keywords "~amd64" --ebuild jetty-6.1.26.ebuild
