...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/xpp3-1.1.4c.pom --download-uri http://central.maven.org/maven2/xpp3/xpp3/1.1.4c/xpp3-1.1.4c-sources.jar --slot 0 --keywords "~amd64" --ebuild xpp3-1.1.4c.ebuild
