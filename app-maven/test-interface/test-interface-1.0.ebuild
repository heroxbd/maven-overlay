...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/test-interface-1.0.pom --download-uri http://central.maven.org/maven2/org/scala-sbt/test-interface/1.0/test-interface-1.0-sources.jar --slot 0 --keywords "~amd64" --ebuild test-interface-1.0.ebuild
