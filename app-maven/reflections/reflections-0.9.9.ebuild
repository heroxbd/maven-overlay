...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/reflections-0.9.9.pom --download-uri http://central.maven.org/maven2/org/reflections/reflections/0.9.9/reflections-0.9.9-sources.jar --slot 0 --keywords "~amd64" --ebuild reflections-0.9.9.ebuild
...
SRC_URI="http://central.maven.org/maven2/org/reflections/reflections/0.9.9/reflections-0.9.9-sources.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
IUSE=""
MAVEN_ID="org.reflections:reflections:0.9.9"

# Common dependencies
# POM: /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/reflections-0.9.9.pom
...
# org.javassist:javassist:3.18.2-GA -> >=dev-java/javassist-3.18.2:3
