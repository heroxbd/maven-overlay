...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/plexus-utils-1.5.6.pom --download-uri http://central.maven.org/maven2/org/codehaus/plexus/plexus-utils/1.5.6/plexus-utils-1.5.6-sources.jar --slot 0 --keywords "~amd64" --ebuild plexus-utils-1.5.6.ebuild
...
# POM: ../poms/plexus-utils-1.5.6.pom
