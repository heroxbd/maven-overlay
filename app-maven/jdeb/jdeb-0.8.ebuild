...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/jdeb-0.8.pom --download-uri http://central.maven.org/maven2/org/vafer/jdeb/0.8/jdeb-0.8-sources.jar --slot 0 --keywords "~amd64" --ebuild jdeb-0.8.ebuild
