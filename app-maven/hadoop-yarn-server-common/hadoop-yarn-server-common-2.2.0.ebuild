...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/hadoop-yarn-server-common-2.2.0.pom --download-uri http://central.maven.org/maven2/org/apache/hadoop/hadoop-yarn-server-common/2.2.0/hadoop-yarn-server-common-2.2.0-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-yarn-server-common-2.2.0.ebuild
...
# Common dependencies
# POM: ../poms/hadoop-yarn-server-common-2.2.0.pom
...
JAVA_GENTOO_CLASSPATH="guice-4,guice-4,protobuf-java,jersey-json,jersey-server,jersey-guice,jersey-test-framework-grizzly2,commons-io-1,netty,hadoop-annotations,hadoop-yarn-common,zookeeper,slf4j-api,slf4j-api"
