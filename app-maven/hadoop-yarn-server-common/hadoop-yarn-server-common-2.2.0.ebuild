...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/hadoop-yarn-server-common-2.2.0.pom --download-uri http://central.maven.org/maven2/org/apache/hadoop/hadoop-yarn-server-common/2.2.0/hadoop-yarn-server-common-2.2.0-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-yarn-server-common-2.2.0.ebuild
...
HOMEPAGE=""
SRC_URI="http://central.maven.org/maven2/org/apache/hadoop/hadoop-yarn-server-common/2.2.0/hadoop-yarn-server-common-2.2.0-sources.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
IUSE=""
MAVEN_ID="org.apache.hadoop:hadoop-yarn-server-common:2.2.0"

# Common dependencies
# POM: /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/hadoop-yarn-server-common-2.2.0.pom
...
JAVA_GENTOO_CLASSPATH="guice-4,guice-4,protobuf-java,jersey-json,jersey-server,jersey-guice,jersey-test-framework-grizzly2,commons-io-1,netty,hadoop-annotations,hadoop-yarn-common,zookeeper,slf4j-log4j12,slf4j-log4j12"
