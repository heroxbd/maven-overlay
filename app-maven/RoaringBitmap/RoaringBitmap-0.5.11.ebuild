...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/RoaringBitmap-0.5.11.pom --download-uri http://central.maven.org/maven2/org/roaringbitmap/RoaringBitmap/0.5.11/RoaringBitmap-0.5.11-sources.jar --slot 0 --keywords "~amd64" --ebuild RoaringBitmap-0.5.11.ebuild
