...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/netty-example-4.0.29.Final.pom --download-uri http://central.maven.org/maven2/io/netty/netty-example/4.0.29.Final/netty-example-4.0.29.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild netty-example-4.0.29.ebuild
...
# Common dependencies
# POM: ../poms/netty-example-4.0.29.Final.pom
