...
JAVA_GENTOO_CLASSPATH="guice-4,protobuf-java,netty,avro,hadoop-annotations,hadoop-mapreduce-client-core,hadoop-yarn-server-nodemanager,slf4j-log4j12,slf4j-log4j12"
