...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/jackson-xc-1.8.3.pom --download-uri http://central.maven.org/maven2/org/codehaus/jackson/jackson-xc/1.8.3/jackson-xc-1.8.3-sources.jar --slot 0 --keywords "~amd64" --ebuild jackson-xc-1.8.3.ebuild
