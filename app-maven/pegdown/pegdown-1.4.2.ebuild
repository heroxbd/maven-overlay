...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/pegdown-1.4.2.pom --download-uri http://central.maven.org/maven2/org/pegdown/pegdown/1.4.2/pegdown-1.4.2-sources.jar --slot 0 --keywords "~amd64" --ebuild pegdown-1.4.2.ebuild
