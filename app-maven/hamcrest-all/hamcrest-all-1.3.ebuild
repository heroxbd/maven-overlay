...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/hamcrest-all-1.3.pom --download-uri http://central.maven.org/maven2/org/hamcrest/hamcrest-all/1.3/hamcrest-all-1.3-sources.jar --slot 0 --keywords "~amd64" --ebuild hamcrest-all-1.3.ebuild
