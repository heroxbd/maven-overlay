...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/minlog-1.3.0.pom --download-uri http://central.maven.org/maven2/com/esotericsoftware/minlog/1.3.0/minlog-1.3.0-sources.jar --slot 0 --keywords "~amd64" --ebuild minlog-1.3.0.ebuild
