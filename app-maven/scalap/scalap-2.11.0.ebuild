...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/scalap-2.11.0.pom --download-uri http://central.maven.org/maven2/org/scala-lang/scalap/2.11.0/scalap-2.11.0-sources.jar --slot 0 --keywords "~amd64" --ebuild scalap-2.11.0.ebuild
