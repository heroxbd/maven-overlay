...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/hadoop-mapreduce-client-jobclient-2.2.0.pom --download-uri http://central.maven.org/maven2/org/apache/hadoop/hadoop-mapreduce-client-jobclient/2.2.0/hadoop-mapreduce-client-jobclient-2.2.0-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-mapreduce-client-jobclient-2.2.0.ebuild
...
# Common dependencies
# POM: ../poms/hadoop-mapreduce-client-jobclient-2.2.0.pom
...
JAVA_GENTOO_CLASSPATH="guice-4,protobuf-java,netty,avro,hadoop-annotations,hadoop-mapreduce-client-common,hadoop-mapreduce-client-shuffle,slf4j-api,slf4j-api"
