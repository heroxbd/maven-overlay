...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/jboss-marshalling-1.3.14.GA.pom --download-uri http://central.maven.org/maven2/org/jboss/marshalling/jboss-marshalling/1.3.14.GA/jboss-marshalling-1.3.14.GA-sources.jar --slot 0 --keywords "~amd64" --ebuild jboss-marshalling-1.3.14.ebuild
...
# POM: ../poms/jboss-marshalling-1.3.14.GA.pom
