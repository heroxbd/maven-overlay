...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/metrics-graphite-3.1.2.pom --download-uri http://central.maven.org/maven2/io/dropwizard/metrics/metrics-graphite/3.1.2/metrics-graphite-3.1.2-sources.jar --slot 0 --keywords "~amd64" --ebuild metrics-graphite-3.1.2.ebuild
...
# Common dependencies
# POM: ../poms/metrics-graphite-3.1.2.pom
