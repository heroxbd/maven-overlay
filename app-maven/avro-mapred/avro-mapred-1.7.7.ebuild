...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/avro-mapred-1.7.7.pom --download-uri http://central.maven.org/maven2/org/apache/avro/avro-mapred/1.7.7/avro-mapred-1.7.7-sources.jar --slot 0 --keywords "~amd64" --ebuild avro-mapred-1.7.7.ebuild
...
# Common dependencies
# POM: /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/avro-mapred-1.7.7.pom
...
JAVA_GENTOO_CLASSPATH="avro-ipc,avro-ipc,jackson-core-asl,jackson-mapper-asl,slf4j-nop,slf4j-nop"
