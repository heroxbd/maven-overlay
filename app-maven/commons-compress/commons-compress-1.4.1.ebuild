...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/commons-compress-1.4.1.pom --download-uri http://central.maven.org/maven2/org/apache/commons/commons-compress/1.4.1/commons-compress-1.4.1-sources.jar --slot 0 --keywords "~amd64" --ebuild commons-compress-1.4.1.ebuild
...
# Common dependencies
# POM: ../poms/commons-compress-1.4.1.pom
