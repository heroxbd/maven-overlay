...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/asm-util-4.1.pom --download-uri http://central.maven.org/maven2/org/ow2/asm/asm-util/4.1/asm-util-4.1-sources.jar --slot 0 --keywords "~amd64" --ebuild asm-util-4.1.ebuild
