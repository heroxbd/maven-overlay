...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/curator-recipes-2.4.0.pom --download-uri http://central.maven.org/maven2/org/apache/curator/curator-recipes/2.4.0/curator-recipes-2.4.0-sources.jar --slot 0 --keywords "~amd64" --ebuild curator-recipes-2.4.0.ebuild
