...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/javax.xml.rpc-3.1.pom --download-uri http://central.maven.org/maven2/org/glassfish/javax.xml.rpc/3.1/javax.xml.rpc-3.1-sources.jar --slot 0 --keywords "~amd64" --ebuild javax-xml-rpc-3.1.ebuild
...
# Common dependencies
# POM: ../poms/javax.xml.rpc-3.1.pom
