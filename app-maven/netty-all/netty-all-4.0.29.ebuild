...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/netty-all-4.0.29.Final.pom --download-uri http://central.maven.org/maven2/io/netty/netty-all/4.0.29.Final/netty-all-4.0.29.Final-sources.jar --slot 0 --keywords "~amd64" --ebuild netty-all-4.0.29.ebuild
...
# Common dependencies
# POM: ../poms/netty-all-4.0.29.Final.pom
...
# io.netty:netty-codec:4.0.29.Final -> >=dev-java/netty-buffer-4.0.21:0
# io.netty:netty-codec-haproxy:4.0.29.Final -> >=dev-java/netty-buffer-4.0.36:0
# io.netty:netty-codec-http:4.0.29.Final -> >=dev-java/netty-buffer-4.0.21:0
# io.netty:netty-codec-socks:4.0.29.Final -> >=dev-java/netty-buffer-4.0.21:0
...
# io.netty:netty-handler:4.0.29.Final -> >=dev-java/netty-buffer-4.0.21:0
...
# io.netty:netty-transport-rxtx:4.0.29.Final -> >=dev-java/netty-buffer-4.0.21:0
# io.netty:netty-transport-sctp:4.0.29.Final -> >=dev-java/netty-buffer-4.0.21:0
# io.netty:netty-transport-udt:4.0.29.Final -> >=dev-java/netty-buffer-4.0.21:0
