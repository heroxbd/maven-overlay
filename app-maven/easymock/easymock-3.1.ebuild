...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/easymock-3.1.pom --download-uri http://central.maven.org/maven2/org/easymock/easymock/3.1/easymock-3.1-sources.jar --slot 0 --keywords "~amd64" --ebuild easymock-3.1.ebuild
...
# Common dependencies
# POM: /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/easymock-3.1.pom
