...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/maven-model-2.1.0.pom --download-uri http://central.maven.org/maven2/org/apache/maven/maven-model/2.1.0/maven-model-2.1.0-sources.jar --slot 0 --keywords "~amd64" --ebuild maven-model-2.1.0.ebuild
...
# Common dependencies
# POM: ../poms/maven-model-2.1.0.pom
