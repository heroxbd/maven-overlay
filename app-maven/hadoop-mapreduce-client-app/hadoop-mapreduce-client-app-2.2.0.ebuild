...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/hadoop-mapreduce-client-app-2.2.0.pom --download-uri http://central.maven.org/maven2/org/apache/hadoop/hadoop-mapreduce-client-app/2.2.0/hadoop-mapreduce-client-app-2.2.0-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-mapreduce-client-app-2.2.0.ebuild
...
HOMEPAGE=""
SRC_URI="http://central.maven.org/maven2/org/apache/hadoop/hadoop-mapreduce-client-app/2.2.0/hadoop-mapreduce-client-app-2.2.0-sources.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
IUSE=""
MAVEN_ID="org.apache.hadoop:hadoop-mapreduce-client-app:2.2.0"

# Common dependencies
# POM: /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/hadoop-mapreduce-client-app-2.2.0.pom
...
# org.apache.hadoop:hadoop-mapreduce-client-common:2.2.0 -> >=app-maven/hadoop-mapreduce-client-common-2.2.0:0
# org.apache.hadoop:hadoop-mapreduce-client-shuffle:2.2.0 -> >=app-maven/hadoop-mapreduce-client-shuffle-2.2.0:0
# org.apache.hadoop:hadoop-yarn-server-web-proxy:2.2.0 -> >=app-maven/hadoop-yarn-server-web-proxy-2.2.0:0
...
CDEPEND="
	...
	>=app-maven/hadoop-mapreduce-client-shuffle-2.2.0:0
...
JAVA_GENTOO_CLASSPATH="guice-4,protobuf-java,netty,avro,hadoop-annotations,hadoop-mapreduce-client-common,hadoop-mapreduce-client-shuffle,hadoop-yarn-server-web-proxy,slf4j-log4j12,slf4j-log4j12"
