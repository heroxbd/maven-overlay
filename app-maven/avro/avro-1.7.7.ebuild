...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/avro-1.7.7.pom --download-uri http://central.maven.org/maven2/org/apache/avro/avro/1.7.7/avro-1.7.7-sources.jar --slot 0 --keywords "~amd64" --ebuild avro-1.7.7.ebuild
...
# org.xerial.snappy:snappy-java:1.0.5 -> >=dev-java/snappy-1.0.3_rc3:1.0
# POM: ../poms/avro-1.7.7.pom
CDEPEND="
...
JAVA_GENTOO_CLASSPATH="paranamer,commons-compress,jackson-core-asl,jackson-mapper-asl,slf4j-api,snappy-1.0,slf4j-api"
