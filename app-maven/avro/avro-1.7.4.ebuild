...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/avro-1.7.4.pom --download-uri http://central.maven.org/maven2/org/apache/avro/avro/1.7.4/avro-1.7.4-sources.jar --slot 0 --keywords "~amd64" --ebuild avro-1.7.4.ebuild
...
SRC_URI="http://central.maven.org/maven2/org/apache/avro/avro/1.7.4/avro-1.7.4-sources.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
IUSE=""
...
# Common dependencies
# POM: /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/avro-1.7.4.pom
