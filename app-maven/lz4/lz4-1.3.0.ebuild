...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/lz4-1.3.0.pom --download-uri http://central.maven.org/maven2/net/jpountz/lz4/lz4/1.3.0/lz4-1.3.0-sources.jar --slot 0 --keywords "~amd64" --ebuild lz4-1.3.0.ebuild
