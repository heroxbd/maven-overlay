...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/commons-math-2.1.pom --download-uri http://central.maven.org/maven2/org/apache/commons/commons-math/2.1/commons-math-2.1-sources.jar --slot 0 --keywords "~amd64" --ebuild commons-math-2.1.ebuild
