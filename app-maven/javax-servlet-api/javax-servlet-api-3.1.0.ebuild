...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/javax.servlet-api-3.1.0.pom --download-uri http://central.maven.org/maven2/javax/servlet/javax.servlet-api/3.1.0/javax.servlet-api-3.1.0-sources.jar --slot 0 --keywords "~amd64" --ebuild javax-servlet-api-3.1.0.ebuild
