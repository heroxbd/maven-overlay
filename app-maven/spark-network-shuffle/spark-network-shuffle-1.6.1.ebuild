...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/spark-network-shuffle_2.10-1.6.1.pom --download-uri http://central.maven.org/maven2/org/apache/spark/spark-network-shuffle_2.10/1.6.1/spark-network-shuffle_2.10-1.6.1-sources.jar --slot 2.10 --keywords "~amd64" --ebuild spark-network-shuffle-1.6.1.ebuild
...
SRC_URI="http://central.maven.org/maven2/org/apache/spark/spark-network-shuffle_2.10/1.6.1/spark-network-shuffle_2.10-1.6.1-sources.jar"
LICENSE=""
SLOT="2.10"
KEYWORDS="~amd64"
IUSE=""
MAVEN_ID="org.apache.spark:spark-network-shuffle_2.10:1.6.1"

# Common dependencies
# POM: /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/spark-network-shuffle_2.10-1.6.1.pom
...
JAVA_GENTOO_CLASSPATH="jackson-annotations-2,jackson-databind-2,spark-network-common-2.10,leveldbjni-all,unused"
