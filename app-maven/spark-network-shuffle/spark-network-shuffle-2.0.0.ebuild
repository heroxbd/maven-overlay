...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/spark-network-shuffle_2.11-2.0.0.pom --download-uri http://central.maven.org/maven2/org/apache/spark/spark-network-shuffle_2.11/2.0.0/spark-network-shuffle_2.11-2.0.0-sources.jar --slot 2.11 --keywords "~amd64" --ebuild spark-network-shuffle-2.0.0.ebuild
