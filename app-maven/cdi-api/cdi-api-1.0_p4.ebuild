...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/cdi-api-1.0-SP4.pom --download-uri http://central.maven.org/maven2/javax/enterprise/cdi-api/1.0-SP4/cdi-api-1.0-SP4-sources.jar --slot 0 --keywords "~amd64" --ebuild cdi-api-1.0_p4.ebuild
