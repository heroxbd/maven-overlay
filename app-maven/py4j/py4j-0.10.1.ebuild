...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/py4j-0.10.1.pom --download-uri http://central.maven.org/maven2/net/sf/py4j/py4j/0.10.1/py4j-0.10.1-sources.jar --slot 0 --keywords "~amd64" --ebuild py4j-0.10.1.ebuild
