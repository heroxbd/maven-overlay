...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/cglib-nodep-2.2.2.pom --download-uri http://central.maven.org/maven2/cglib/cglib-nodep/2.2.2/cglib-nodep-2.2.2-sources.jar --slot 0 --keywords "~amd64" --ebuild cglib-nodep-2.2.2.ebuild
...
# Common dependencies
# POM: ../poms/cglib-nodep-2.2.2.pom
