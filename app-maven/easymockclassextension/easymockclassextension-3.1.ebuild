...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/easymockclassextension-3.1.pom --download-uri http://central.maven.org/maven2/org/easymock/easymockclassextension/3.1/easymockclassextension-3.1-sources.jar --slot 0 --keywords "~amd64" --ebuild easymockclassextension-3.1.ebuild
...
# Common dependencies
# POM: ../poms/easymockclassextension-3.1.pom
