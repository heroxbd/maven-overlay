...
# org.slf4j:slf4j-log4j12:1.6.1 -> >=dev-java/slf4j-simple-1.7.7:0
...
JAVA_GENTOO_CLASSPATH="commons-collections,commons-lang,jdiff-bin,jline-2,log4j,apache-rat-tasks,netty,slf4j-simple,slf4j-simple,jdeb,xerces-2"
