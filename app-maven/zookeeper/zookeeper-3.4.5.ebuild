...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/zookeeper-3.4.5.pom --download-uri http://central.maven.org/maven2/org/apache/zookeeper/zookeeper/3.4.5/zookeeper-3.4.5-sources.jar --slot 0 --keywords "~amd64" --ebuild zookeeper-3.4.5.ebuild
...
# org.slf4j:slf4j-log4j12:1.6.1 -> >=dev-java/slf4j-nop-1.7.7:0
