...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/wagon-provider-api-1.0-beta-5.pom --download-uri http://central.maven.org/maven2/org/apache/maven/wagon/wagon-provider-api/1.0-beta-5/wagon-provider-api-1.0-beta-5-sources.jar --slot 0 --keywords "~amd64" --ebuild wagon-provider-api-1.0_beta5.ebuild
...
# Common dependencies
# POM: ../poms/wagon-provider-api-1.0-beta-5.pom
