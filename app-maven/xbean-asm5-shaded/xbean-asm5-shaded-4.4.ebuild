...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/xbean-asm5-shaded-4.4.pom --download-uri http://central.maven.org/maven2/org/apache/xbean/xbean-asm5-shaded/4.4/xbean-asm5-shaded-4.4-sources.jar --slot 0 --keywords "~amd64" --ebuild xbean-asm5-shaded-4.4.ebuild
