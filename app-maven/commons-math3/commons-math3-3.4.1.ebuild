...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/commons-math3-3.4.1.pom --download-uri http://central.maven.org/maven2/org/apache/commons/commons-math3/3.4.1/commons-math3-3.4.1-sources.jar --slot 0 --keywords "~amd64" --ebuild commons-math3-3.4.1.ebuild
