...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/stax-api-1.0-2.pom --download-uri http://central.maven.org/maven2/javax/xml/stream/stax-api/1.0-2/stax-api-1.0-2-sources.jar --slot 0 --keywords "~amd64" --ebuild stax-api-1.0.2.ebuild
