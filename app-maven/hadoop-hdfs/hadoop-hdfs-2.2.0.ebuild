...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/hadoop-hdfs-2.2.0.pom --download-uri http://central.maven.org/maven2/org/apache/hadoop/hadoop-hdfs/2.2.0/hadoop-hdfs-2.2.0-sources.jar --slot 0 --keywords "~amd64" --ebuild hadoop-hdfs-2.2.0.ebuild
