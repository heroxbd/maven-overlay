...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/gcsio-1.4.1.pom --download-uri http://central.maven.org/maven2/com/google/cloud/bigdataoss/gcsio/1.4.1/gcsio-1.4.1-sources.jar --slot 0 --keywords "~amd64" --ebuild gcsio-1.4.1.ebuild
...
DESCRIPTION="An implementation of org.apache.hadoop.fs.FileSystem targeting Google Cloud Storage"
HOMEPAGE="https://github.com/GoogleCloudPlatform/BigData-interop/gcsio/"
SRC_URI="http://central.maven.org/maven2/com/google/cloud/bigdataoss/gcsio/1.4.1/gcsio-1.4.1-sources.jar"
LICENSE=""
SLOT="0"
KEYWORDS="~amd64"
IUSE=""
MAVEN_ID="com.google.cloud.bigdataoss:gcsio:1.4.1"

# Common dependencies
# POM: /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/gcsio-1.4.1.pom
...
JAVA_GENTOO_CLASSPATH="google-api-client-jackson2,google-api-client-java6,google-api-services-storage,util,jsr305-bin,guava-10,google-oauth-client,google-oauth-client-java6"
