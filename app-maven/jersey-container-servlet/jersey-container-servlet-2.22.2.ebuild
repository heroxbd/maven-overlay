...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/jersey-container-servlet-2.22.2.pom --download-uri http://central.maven.org/maven2/org/glassfish/jersey/containers/jersey-container-servlet/2.22.2/jersey-container-servlet-2.22.2-sources.jar --slot 0 --keywords "~amd64" --ebuild jersey-container-servlet-2.22.2.ebuild
...
# Common dependencies
# POM: ../poms/jersey-container-servlet-2.22.2.pom
