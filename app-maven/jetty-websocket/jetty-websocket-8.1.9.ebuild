...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/jetty-websocket-8.1.9.v20130131.pom --download-uri http://central.maven.org/maven2/org/eclipse/jetty/jetty-websocket/8.1.9.v20130131/jetty-websocket-8.1.9.v20130131-sources.jar --slot 0 --keywords "~amd64" --ebuild jetty-websocket-8.1.9.ebuild
...
# Common dependencies
# POM: ../poms/jetty-websocket-8.1.9.v20130131.pom
