...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom ../poms/protobuf-java-2.5.0.pom --download-uri http://central.maven.org/maven2/com/google/protobuf/protobuf-java/2.5.0/protobuf-java-2.5.0-sources.jar --slot 0 --keywords "~amd64" --ebuild protobuf-java-2.5.0.ebuild
