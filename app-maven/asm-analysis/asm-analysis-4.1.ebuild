...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/asm-analysis-4.1.pom --download-uri http://central.maven.org/maven2/org/ow2/asm/asm-analysis/4.1/asm-analysis-4.1-sources.jar --slot 0 --keywords "~amd64" --ebuild asm-analysis-4.1.ebuild
...
# Common dependencies
# POM: /fefs/disk/usr100/gentoo/var/lib/java-ebuilder/poms/asm-analysis-4.1.pom
